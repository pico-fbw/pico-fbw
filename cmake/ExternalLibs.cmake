...
list(APPEND EXTERNALLIBS_SOURCES ${littlefs_SOURCE_DIR}/lfs.c ${littlefs_SOURCE_DIR}/lfs_util.c)
...
list(APPEND EXTERNALLIBS_SOURCES ${minmea_SOURCE_DIR}/minmea.c)
...
list(APPEND EXTERNALLIBS_SOURCES ${parson_SOURCE_DIR}/parson.c)
...
list(APPEND EXTERNALLIBS_SOURCES ${semver_SOURCE_DIR}/semver.c)

...
function(setup_after_subdirs)
    ...
    # Tell the pico-sdk to generate extra outputs, which includes .uf2 (easier to upload)
    ...
    set(MEMMAP_FILE_PATH ${PLATFORM_PATH}/resources/${MEMMAP_FILE}.ld.in)
    if (NOT EXISTS ${MEMMAP_FILE_PATH})
        message(FATAL_ERROR "Unsupported Pico platform (${PICO_PLATFORM})")
    endif()
    message("Linking with custom ${MEMMAP_FILE}.ld")
    configure_file(${MEMMAP_FILE_PATH} ${CMAKE_BINARY_DIR}/memmap.ld)

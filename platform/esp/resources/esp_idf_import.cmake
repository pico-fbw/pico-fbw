...
if (NOT IDF_PATH)
    message(FATAL_ERROR "IDF_PATH is not set. To build for ${FBW_PLATFORM}, you must download ESP-IDF and set the IDF_PATH
...
if (NOT TOOLS_IN_PATH)
    ...
    message(STATUS "You probably didn't run `export.sh` (Mac/Linux) or `export.bat` (Windows) from the

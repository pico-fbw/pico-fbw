...
#define DEADBAND config.control.controlDeadband
#define ROLL_INPUT() (fabsf(receiver_get((i16)config.pins.inputAil, RECEIVER_MODE_DEGREE) - 90.f) > DEADBAND)
#define PITCH_INPUT() (fabsf(receiver_get((i16)config.pins.inputEle, RECEIVER_MODE_DEGREE) - 90.f) > DEADBAND)
#define YAW_INPUT()                                                                                                    \
    (receiver_has_rud() && fabsf(receiver_get((i16)config.pins.inputRud, RECEIVER_MODE_DEGREE) - 90.f) > DEADBAND)

...
void api_help(const char *cmd, const char *args) {
    printf("\npico-fbw API v%s\n"
           "Commands:\n"
           "GET_CONFIG <section> <key> - Get configuration value (providing no arguments will list all)\n"
           ...
           "SET_CONFIG <section> <key> <value> - Set configuration value (no args will save to flash)\n"

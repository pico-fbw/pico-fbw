...
#define PINS_EQUAL(p1, p2) ((p1) == (p2))
    ...
    PINS_EQUAL(INPUT_AIL_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(SERVO_AIL_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(INPUT_ELEV_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(SERVO_ELEV_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(INPUT_RUD_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(SERVO_RUD_PIN, MODE_SWITCH_PIN) || \
    ...
    PINS_EQUAL(MODE_SWITCH_PIN, IMU_SDA_PIN) || \
    PINS_EQUAL(MODE_SWITCH_PIN, IMU_SCL_PIN) || \
    PINS_EQUAL(MODE_SWITCH_PIN, GPS_TX_PIN) || \
    PINS_EQUAL(MODE_SWITCH_PIN, GPS_RX_PIN) || \

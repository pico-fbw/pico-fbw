...
// https://www.nxp.com/docs/en/application-note/AN5019.pdf
...
#define CAL_INTERVAL_SECS 300			///< 300s or 5min interval for regular calibration checks // TODO: does this need to be changed?

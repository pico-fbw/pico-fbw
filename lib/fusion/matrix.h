...
void fmatrixAeqI(
    ...
    i16 rc                    ///< dimension of the matrix
);
...
void fEigenCompute10(
    ...
    i8 n                      ///< n can vary up to and including 10 but the matrices A and eigvec must have 10 columns.
);
/// function computes all eigenvalues and eigenvectors of a real symmetric matrix A[0..n-1][0..n-1]
...
void fEigenCompute4(
    ...
    i8 n                      ///< n can vary up to and including 4 but the matrices A and eigvec must have 4 columns.
);
...
void fveqRu(
    ...
    i8 itranspose     ///< true if inverse direction desired
);
